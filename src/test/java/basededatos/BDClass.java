...
public class BDClass {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/UsuariosR";//UsuariosR//localhost
    private static final String USUARIO = "elzevir";//"root"//"elzevir"//3608726_sqlelzevir
